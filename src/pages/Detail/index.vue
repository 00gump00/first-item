          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              >
                ...
                <dd
                  changepirce="0"
                  @click="getLight(index)"
                  :class="{ active: selfvalue == index }"
                >
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <a href="javascript:" @click="changeShopCart">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
export default {
  mounted() {
    ...
    this.$store.dispatch("getGoodsData", this.$route.params.key);
  },
  data() {
    return {
      //自定义用于样式的显隐藏
  ...
  methods: {
    ...
    async changeShopCart() {
      //发送失败给予提示
      try {
        let result = await this.$store.dispatch("addToShopCart", {
          skuId: this.$route.params.key,
          skuNum: this.skuNum,
        });
