  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li class="with-x" v-if="searchParams.categoryName">
              {{ searchParams.categoryName }}<i @click="getDelete">×</i>
            </li>
        ...
        <!--selector-->
        <SearchSelector @addtradeMark="tramarkAdd" />
              ...
              >
                <div class="list-wrap">
                  <div class="p-img">
                    ...
                    <router-link  :to="`/detail/${list.id}`"  target="_blank"
...
export default {
  ...
  computed: {
    ...
    ...mapState({
      ...
      totalPages: (state) => {
        return state.search.searchdata.totalPages;
      },
    }),
  },
  mounted() {
  ...
  methods: {
    ...
    //处理面包屑、跳转到初始位置
    getDelete() {
      this.searchParams.categoryName = "";//undefined 将不会带给服务器
    ...
    change(flag) {
      ...
      // this.searchParams.order=`${flag}:${'asc'?'desc':'asc'}`
      let newOrder = "";
      if (flag == originNum) {
        newOrder = `${originNum}:${originState == "desc" ? "asc" : "desc"}`;
      } else {
        newOrder = `${flag}:${"desc"}`;
      }
